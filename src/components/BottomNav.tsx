...
const items: Item[] = [
  ...
  { to: "/social", icon: Trophy, label: "Comunidade" },
...
export function BottomNav() {
  ...
  return (
    <nav
      className="fixed bottom-0 inset-x-0 z-40 pb-safe border-t"
      style={{
            ...
            >
              ...
              >
                ...
                <Icon
                  ...
                  style={
                    active ? { filter: "drop-shadow(0 0 6px oklch(0.72 0.18 250 / 0.6))" } : {}
                  }
                  strokeWidth={2.2}
                />
